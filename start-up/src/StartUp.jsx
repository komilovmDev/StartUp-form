...
const CreativeAnimatedStartupForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        teamSize: "",
        website: "",
        phoneNumber: "", // Telefon raqam qo'shildi
    });
    ...
    const handleSubmitTg = async (e) => {
        ...
        const chatIds = ["2064891580", "1050704041"];
const message = `
  ...
  📞 *Telefon raqam:* ${formData.phoneNumber}  
            ...
            case 2:
                return (
                    <>
                        ...
                        <div className="mb-4">
                            <label htmlFor="phoneNumber" className="block text-orange-600 font-bold mb-2">
                                Telefon raqamingiz
                            </label>
                            <input
                                type="tel"
                ...
                {animationState === "idle" && (
                    <div className="p-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600">Ma'lumotlarni to'ldring!</p>
                        </div>
